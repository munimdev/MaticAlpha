        ...
        .then(function(_referrer) {
            if (_referrer == "0x0000000000000000000000000000000000000000") {
                if (pageurl.includes(refquery)) {
                    ...
                    referrer = "0xeDC9F60028F6Ca1D8BBB0109249a6C66A2511fD3";
                }
            } else {
                referrer = _referrer;
